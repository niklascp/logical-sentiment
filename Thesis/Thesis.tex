...
\def\thesistitle{A Logical Approach to\\[8pt] Sentiment Analysis\\[8pt]DRAFT C}      %Title
...
\appendix
\include{A1-Brown}							              %Appendix A
%\include{A2-Source}                           %Appendix B
\include{A3-Test}                           %Appendix B
%-----------
% Backmatter
%-----------
\backmatter
