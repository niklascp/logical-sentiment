...
\newcommand{\inference}[3][]{
	...
	{ \: } % if #1 is empty
	{\hspace{-6pt}\begin{array}{l}\scriptstyle{\mathbf{#1}} \\ \vspace{-11pt} \end{array} } % if #1 is not empty
}
...
\def\thesistitle{A Logical Approach to\\[8pt] Sentiment Analysis}      %Title
