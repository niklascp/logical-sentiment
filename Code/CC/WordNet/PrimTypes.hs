...
module WordNet.PrimTypes where
...
data EPOS = POS POS | Satellite | AdjSatellite | IndirectAnt | DirectAnt | UnknownEPos
...
newtype Key = Key (Offset, POS) deriving (Eq, Ord, Typeable)
